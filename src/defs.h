...
/*----------------------------------------------------------------------------*/
/* NELEM_INT_STARP  = number of integer elements in StarParS structure
 * NELEM_REAL_STARP = number of real elements in StarParS structure
 * NSINK_STARP      = size of sink regions
 * NGHOST_STARP     = size of the regions inside which fluxes are modified */
#ifdef STAR_PARTICLE
#define NELEM_INT_STARP 3
#define NELEM_REAL_STARP 24
#define NELEM_STARP (NELEM_INT_STARP + NELEM_REAL_STARP)
#define NSINK_STARP 1
#define NGHOST_STARP 1
#define NHII 2
#define NSN 2
#endif /* STAR_PARTICLE */
