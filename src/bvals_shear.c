...
/* Post a non-blocking receive for the input data from the left grid */
    ...
    if(ierr != MPI_SUCCESS) 
#endif
      ath_perr(-1,"[RemapVar] MPI recv error %d: set periodic in left-Y!\n",myID_Comm_world);
...
/* send contents of buffer to the neighboring grid on R-x2 */
    ...
    if(ierr != MPI_SUCCESS) 
#endif
      ath_perr(-1,"[RemapVar] MPI send error: set periodic in left-Y!\n");
...
/* Wait to receive the input data from the left grid */
    ...
    if(ierr != MPI_SUCCESS) 
#endif
      ath_perr(-1,"[RemapVar] MPI wait error: set periodic in left-Y!\n");
...
/* Post a non-blocking receive for the input data from the right grid */
    ...
    if(ierr != MPI_SUCCESS) 
#endif
      ath_perr(-1,"[RemapVar] MPI recv error %d: set periodic in right-Y!\n",myID_Comm_world);
...
/* send contents of buffer to the neighboring grid on L-x2 */
    ...
    if(ierr != MPI_SUCCESS) 
#endif
      ath_perr(-1,"[RemapVar] MPI send error: set periodic in right-Y!\n");
...
/* Wait to receive the input data from the left grid */
    ...
    if(ierr != MPI_SUCCESS) 
#endif
      ath_perr(-1,"[RemapVar] MPI wait error: set periodic in right-Y!\n");
...
/* Post a non-blocking receive for the input data */
      ...
      if(ierr != MPI_SUCCESS) 
#endif
        ath_perr(-1,"[RemapVar] MPI recv error %d: joffset>0!\n",myID_Comm_world);
      ...
      if(ierr != MPI_SUCCESS) 
#endif
        ath_perr(-1,"[RemapVar] MPI send error: joffset>0!\n");
 ...
 * [js:js+(joverlap-1)] in GhstZns */
      ...
      if(ierr != MPI_SUCCESS) 
#endif
        ath_perr(-1,"[RemapVar] MPI wait error: joffset>0!\n");
